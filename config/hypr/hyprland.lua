...
local bar         = "qs -p /home/dennis/.config/quickshell/shell.qml"
local wallPaper   = "swaybg -i /home/dennis/wallpapers/wall1.png"
-------------------
---- AUTOSTART ----
-------------------
...
hl.env("HYPRCURSOR_THEME", "Bibata-Modern-Hypr")
...
hl.window_rule({
    match = { class = "kitty" },
    opacity = "0.7 override 0.7 override 1.0 override", -- active, inactive, fullscreen
})
